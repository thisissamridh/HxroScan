...
const PriceOverTimeGraph: React.FC = () => {
    ...
    const [dataDomain, setDataDomain] = useState([0, 'auto']); // domain for X-axis
    ...
    const CustomBrushHandle = () => (
        <g>
            <rect
                ...
                width={12}
                height={20}
                fill="#8884d8"  // same color as the brush stroke
                rx={2}
                ry={2}
            />
            <path
                d="M 0.5 25 V 35 M -5.5 30 H 6"
                stroke="white"
                strokeLinecap="round"
                strokeWidth={2}
            />
                ...
                <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={trades[selectedProduct]}>
                        ...
                        <Brush
                            ...
                            height={20}  // slightly increase the height for better visibility
                            stroke="#8884d8"  // main color for the brush
                            fill="#f5f5f5"  // background fill of the selected area
                            travellerWidth={5}  // width of the handles

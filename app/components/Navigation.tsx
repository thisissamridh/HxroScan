            ...
            <div className="drawer-content">
                ...
                <div className="navbar flex rounded-box flex-wrap items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start' }} className="bg-white/30 hidden md:inline-block backdrop-sepia-0 text-white px-4 py-2 rounded">
                            {icon && <img src={icon} alt="Icon" className="h-6 w-auto mr-2 " />}  {/* Icon on the first line */}
